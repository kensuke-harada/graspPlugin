   ...
   public virtual PortableServer::RefCountServantBase
{
 ...
 public:
   ...
   */
   ...
   // attributes and operations
   void GraspPlanningResult(const GraspPlanResult::DblSequence3& GraspPos, const GraspPlanResult::DblSequence9& GraspOri, const GraspPlanResult::DblSequence3& ApproachPos, const GraspPlanResult::DblSequence9& ApproachOri, const GraspPlanResult::DblSequence& angle, ::CORBA::ULong state, ::CORBA::ULong& isContinue);
   void ReleasePlanningResult(const GraspPlanResult::DblSequence3& GraspPos, const GraspPlanResult::DblSequence9& GraspOri, const GraspPlanResult::DblSequence3& ApproachPos, const GraspPlanResult::DblSequence9& ApproachOri, const GraspPlanResult::DblSequence& angle, ::CORBA::ULong state, ::CORBA::ULong& isContinue);
