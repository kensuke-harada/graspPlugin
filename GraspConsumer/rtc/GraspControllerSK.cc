...
const char* const _0RL_cd_9e8065595ff2dcff_00000000::_user_exns[] = {
  0
};
...
// Proxy call descriptor class. Mangled signature:
//  void_i_cGraspPlanResult_mDblSequence3_i_cGraspPlanResult_mDblSequence9_i_cGraspPlanResult_mDblSequence3_i_cGraspPlanResult_mDblSequence9_i_cGraspPlanResult_mDblSequence_i_cunsigned_plong_o_cunsigned_plong
...
public:
  ...
  GraspPlanResult::DblSequence_var arg_4_;
  const GraspPlanResult::DblSequence* arg_4;
  ::CORBA::ULong arg_5;
  ::CORBA::ULong arg_6;
};
...
void _0RL_cd_9e8065595ff2dcff_30000000::marshalArguments(cdrStream& _n)
{
  ...
  (const GraspPlanResult::DblSequence&) *arg_4 >>= _n;
  arg_5 >>= _n;
...
void _0RL_cd_9e8065595ff2dcff_30000000::unmarshalArguments(cdrStream& _n)
{
  ...
  arg_3 = &arg_3_.in();
  arg_4_ = new GraspPlanResult::DblSequence;
  (GraspPlanResult::DblSequence&)arg_4_ <<= _n;
  arg_4 = &arg_4_.in();
...
const char* const _0RL_cd_9e8065595ff2dcff_30000000::_user_exns[] = {
  0
};
...
void _objref_GraspPlanResult::GraspPlanningResult(const ::GraspPlanResult::DblSequence3& GraspPos, const ::GraspPlanResult::DblSequence9& GraspOri, const ::GraspPlanResult::DblSequence3& ApproachPos, const ::GraspPlanResult::DblSequence9& ApproachOri, const ::GraspPlanResult::DblSequence& angle, ::CORBA::ULong state, ::CORBA::ULong& isContinue)
{
  ...
  _call_desc.arg_4 = &(::GraspPlanResult::DblSequence&) angle;
...
void _objref_GraspPlanResult::ReleasePlanningResult(const ::GraspPlanResult::DblSequence3& GraspPos, const ::GraspPlanResult::DblSequence9& GraspOri, const ::GraspPlanResult::DblSequence3& ApproachPos, const ::GraspPlanResult::DblSequence9& ApproachOri, const ::GraspPlanResult::DblSequence& angle, ::CORBA::ULong state, ::CORBA::ULong& isContinue)
{
