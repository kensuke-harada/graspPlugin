...
static CORBA::TypeCode_ptr _0RL_tc_GraspPlanResult_mDblSequence = CORBA::TypeCode::PR_alias_tc("IDL:GraspPlanResult/DblSequence:1.0", "DblSequence", CORBA::TypeCode::PR_sequence_tc(0, CORBA::TypeCode::PR_double_tc(), &_0RL_tcTrack), &_0RL_tcTrack);


const CORBA::TypeCode_ptr GraspPlanResult::_tc_DblSequence = _0RL_tc_GraspPlanResult_mDblSequence;
...
static void _0RL_GraspPlanResult_mDblSequence_marshal_fn(cdrStream& _s, void* _v)
{
  GraspPlanResult::DblSequence* _p = (GraspPlanResult::DblSequence*)_v;
  *_p >>= _s;
}
static void _0RL_GraspPlanResult_mDblSequence_unmarshal_fn(cdrStream& _s, void*& _v)
{
  GraspPlanResult::DblSequence* _p = new GraspPlanResult::DblSequence;
  *_p <<= _s;
  _v = _p;
}
static void _0RL_GraspPlanResult_mDblSequence_destructor_fn(void* _v)
{
  GraspPlanResult::DblSequence* _p = (GraspPlanResult::DblSequence*)_v;
  delete _p;
}
...
{
  GraspPlanResult::DblSequence* _p = new GraspPlanResult::DblSequence(_s);
  _a.PR_insert(_0RL_tc_GraspPlanResult_mDblSequence,
               _0RL_GraspPlanResult_mDblSequence_marshal_fn,
               _0RL_GraspPlanResult_mDblSequence_destructor_fn,
               _p);
}
...
::CORBA::Boolean operator>>=(const ::CORBA::Any& _a, GraspPlanResult::DblSequence*& _sp)
{
  return _a >>= (const GraspPlanResult::DblSequence*&) _sp;
}
::CORBA::Boolean operator>>=(const ::CORBA::Any& _a, const GraspPlanResult::DblSequence*& _sp)
{
  void* _v;
  if (_a.PR_extract(_0RL_tc_GraspPlanResult_mDblSequence,
                    _0RL_GraspPlanResult_mDblSequence_unmarshal_fn,
                    _0RL_GraspPlanResult_mDblSequence_marshal_fn,
                    _0RL_GraspPlanResult_mDblSequence_destructor_fn,
                    _v)) {
    _sp = (const GraspPlanResult::DblSequence*)_v;
    return 1;
  }
  return 0;
}
