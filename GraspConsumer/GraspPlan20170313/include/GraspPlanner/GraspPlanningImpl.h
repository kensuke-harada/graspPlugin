...
public :
	...
	bool returnGraspPosition(dmatrix::dVector3& GraspPos, dmatrix::dMatrix33& GraspOri, dmatrix::dVector3& ApproachPos, dmatrix::dMatrix33& ApproachOri, std::vector<double>& angle, int& states);
