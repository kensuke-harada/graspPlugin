   ...
   public virtual PortableServer::RefCountServantBase
{
 ...
 public:
   ...
   */
   ...
   // attributes and operations
   void GraspPlanningResult(const GraspPlanStart::DblSequence3& GraspPos, const GraspPlanStart::DblSequence9& GraspOri, const GraspPlanStart::DblSequence3& ApproachPos, const GraspPlanStart::DblSequence9& ApproachOri, const GraspPlanResult::DblSequence& angle, ::CORBA::ULong state, ::CORBA::ULong& isContinue);
   void ReleasePlanningResult(const GraspPlanStart::DblSequence3& GraspPos, const GraspPlanStart::DblSequence9& GraspOri, const GraspPlanStart::DblSequence3& ApproachPos, const GraspPlanStart::DblSequence9& ApproachOri, const GraspPlanResult::DblSequence& angle, ::CORBA::ULong state, ::CORBA::ULong& isContinue);
