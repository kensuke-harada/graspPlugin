...
bool GraspPlanning_impl::returnGraspPosition(dVector3& GraspPos, dMatrix33& GraspOri, dVector3& ApproachPos, dMatrix33& ApproachOri, std::vector<double>& angle, int& states){
	...
	int angle_size = record.size() - 12;
	angle.clear();
	angle.resize(angle_size);
