...
using dmatrix::dMatrix33;
using dmatrix::dVector3;
/*
...
//	selectgraspposition
	...
	while(isContinue){
		...
		int angle_size = angle_.size();
		GraspPlanResult::DblSequence angle;
		angle.length(angle_size);
 ...
 * Methods corresponding to IDL attributes and operations
 */
void GraspPlanResultSVC_impl::GraspPlanningResult(const GraspPlanStart::DblSequence3& GraspPos, const GraspPlanStart::DblSequence9& GraspOri, const GraspPlanStart::DblSequence3& ApproachPos, const GraspPlanStart::DblSequence9& ApproachOri, const GraspPlanResult::DblSequence& angle, ::CORBA::ULong state, ::CORBA::ULong& isContinue)
{
  // Please insert your code here and remove the following warning pragma
}

void GraspPlanResultSVC_impl::ReleasePlanningResult(const GraspPlanStart::DblSequence3& GraspPos, const GraspPlanStart::DblSequence9& GraspOri, const GraspPlanStart::DblSequence3& ApproachPos, const GraspPlanStart::DblSequence9& ApproachOri, const GraspPlanResult::DblSequence& angle, ::CORBA::ULong state, ::CORBA::ULong& isContinue)
{
  // Please insert your code here and remove the following warning pragma
}
