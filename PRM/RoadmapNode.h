...
namespace PathEngine {
   ...
   * @brief ロードマップのノード
   */
  class EXCADE_API RoadmapNode {
  public:
    /**
     * @brief コンストラクタ
     * @param pos このノードの座標
     */
    RoadmapNode(const Configuration& pos) : pos_(pos) , cost_(0.0), is_valid_(true) {}
