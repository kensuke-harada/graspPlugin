...
namespace PathEngine{
    ...
    public:
        ...
        /**
         * @brief get nodes within a distance of @c distance.
         * @param[in] cfg target configuration
         * @param[in] distance maximum distance
         * @param[out] nodes near configuration @c cfg
         */
        void findNearNodes(const Configuration& cfg, double distance, std::vector<RoadmapNodePtr> &nodes);

        /**
         * @brief get k-NN node.
         * @param[in] cfg target configuration
         * @param[in] k k
         * @param[out] nodes NN nodes
         */
        void findKNearNodes(const Configuration& cfg, int k, std::vector<RoadmapNodePtr> &nodes);
