...
void ConfigurationSpace::setDoF(unsigned int i_rank, bool DoF)
{
    m_isFree[i_rank] = DoF;
}
...
void ConfigurationSpace::setInitValue(unsigned int i_rank, double value)
{
    m_initvalue[i_rank] = value;
}
