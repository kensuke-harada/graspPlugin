...
namespace PathEngine {
  ...
  public:
     ...
     */
    bool isReachable(Configuration& from, Configuration& to, bool checkCollision=true, CollisionChecker* col_checker = NULL, bool docheckstart = true, bool docheckend = true) const;
