...
void operator<<=(::CORBA::Any& _a, const RTC::DoubleSeq& _s);
void operator<<=(::CORBA::Any& _a, RTC::DoubleSeq* _sp);
_CORBA_Boolean operator>>=(const ::CORBA::Any& _a, RTC::DoubleSeq*& _sp);
_CORBA_Boolean operator>>=(const ::CORBA::Any& _a, const RTC::DoubleSeq*& _sp);

void operator<<=(::CORBA::Any& _a, const RTC::JointPos& _s);
void operator<<=(::CORBA::Any& _a, RTC::JointPos* _sp);
_CORBA_Boolean operator>>=(const ::CORBA::Any& _a, RTC::JointPos*& _sp);
_CORBA_Boolean operator>>=(const ::CORBA::Any& _a, const RTC::JointPos*& _sp);

extern void operator<<=(::CORBA::Any& _a, const RTC::LimitValue& _s);
extern void operator<<=(::CORBA::Any& _a, RTC::LimitValue* _sp);
extern _CORBA_Boolean operator>>=(const ::CORBA::Any& _a, RTC::LimitValue*& _sp);
extern _CORBA_Boolean operator>>=(const ::CORBA::Any& _a, const RTC::LimitValue*& _sp);

extern void operator<<=(::CORBA::Any& _a, const RTC::RETURN_ID& _s);
extern void operator<<=(::CORBA::Any& _a, RTC::RETURN_ID* _sp);
extern _CORBA_Boolean operator>>=(const ::CORBA::Any& _a, RTC::RETURN_ID*& _sp);
extern _CORBA_Boolean operator>>=(const ::CORBA::Any& _a, const RTC::RETURN_ID*& _sp);

extern void operator<<=(::CORBA::Any& _a, const RTC::TimedJointPos& _s);
extern void operator<<=(::CORBA::Any& _a, RTC::TimedJointPos* _sp);
extern _CORBA_Boolean operator>>=(const ::CORBA::Any& _a, RTC::TimedJointPos*& _sp);
extern _CORBA_Boolean operator>>=(const ::CORBA::Any& _a, const RTC::TimedJointPos*& _sp);
