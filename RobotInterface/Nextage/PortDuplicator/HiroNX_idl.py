...
HiroNX._d_rhandAttach = ((), (), None)
HiroNX._d_rhandDetach = ((), (), None)
HiroNX._d_lhandAttach = ((), (), None)
HiroNX._d_lhandDetach = ((), (), None)
...
class _objref_HiroNX (CORBA.Object):
    ...
    def rhandAttach(self, *args):
        return _omnipy.invoke(self, "rhandAttach", _0__GlobalIDL.HiroNX._d_rhandAttach, args)

    def rhandDetach(self, *args):
        return _omnipy.invoke(self, "rhandDetach", _0__GlobalIDL.HiroNX._d_rhandDetach, args)

    def lhandAttach(self, *args):
        return _omnipy.invoke(self, "lhandAttach", _0__GlobalIDL.HiroNX._d_lhandAttach, args)

    def lhandDetach(self, *args):
        return _omnipy.invoke(self, "lhandDetach", _0__GlobalIDL.HiroNX._d_lhandDetach, args)

    __methods__ = ["setupRobot", "restart", "goInitial", "goOffPose", "servoOn", "servoOff", "calibrateJoint", "servoOnHands", "servoOffHands", "EngageProtectiveStop", "DisengageProtectiveStop", "reboot", "shutdown", "rhandOpen", "rhandClose", "lhandOpen", "lhandClose", "rhandAttach", "rhandDetach", "lhandAttach", "lhandDetach"] + CORBA.Object.__methods__
