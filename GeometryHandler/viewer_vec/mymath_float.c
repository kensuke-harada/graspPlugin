...
float
maxd_float(float a, float b){
	if(a > b) return a;
	return b;
}

void
subtract_2_vector_float(float *result,float *plus,float *minus){
	int i;
...
void
add_2_vector_float(float *result,float *pos1,float *pos2){
	int i;
...
float
inner_product_2_vector_float(float *nml1,float *nml2){
...
float
inner_product_3_point_float(float *minus,float *pos1,float *pos2){
...
void
outer_product_3_points_float(float *result,float *minus,float *pos1,float *pos2){
	int i;
...
void
outer_product_2_vector_float(float *result,float *vec1,float *vec2){
	int i;
...
void
multiple_scalar_vector_float(float *result,float s,float *vec){
	int i;
...
float
determinant_of_3_vector_float(float a[3], float b[3], float c[3]){
...
float
inverse_matrix_float(float result[3][3],float a[3][3]){
	float det;
	
	det = determinant_float(a);
	if(det == 0) return det;
...
void
translate_cordinate_float(float result[3],float a[3][3],float r[3]){
	int i;
...
float
distance_2_point_power_float(float *pos1,float *pos2){
...
float
distance_2_point_float(float *pos1,float *pos2){
	return sqrt(distance_2_point_power_float(pos1,pos2));
}

float
distance_2_point_2dimension_float(float *pos1,float *pos2){
...
float
vector_length_float(float *vec){
	float o[3] = {0.0,0.0,0.0};
	return distance_2_point_float(vec,o);
}

float
distance_point_and_line_float(float *pos,float *posl1,float *posl2){
	float aa,bb,ab;
	
	aa = distance_2_point_power_float(posl1,posl2);
	bb = distance_2_point_power_float(pos,posl1);
	ab = inner_product_3_point_float(posl1,pos,posl2);
...
void
rotation_vector_float(float vec[3], float ra, float rb, float rg){
	float v1[3],v2[3];
