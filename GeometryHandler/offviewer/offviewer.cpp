...
ReadOffFile(const char *filename)
{
  ...
  FILE *fp_out;
  fp_out = fopen("sample.wrl", "w");
  fprintf(fp_out, "#VRML V2.0 utf8\n");
  fprintf(fp_out, "\n");
  fprintf(fp_out, "    Transform {\n");
  fprintf(fp_out, "      children  Shape {\n");
  fprintf(fp_out, "	appearance	Appearance {\n");
  fprintf(fp_out, "		  material	DEF BANANA_light_or Material {\n");
  fprintf(fp_out, "			    ambientIntensity	0.477124\n");
  fprintf(fp_out, "			    diffuseColor	0.5 0.5 0.5\n");
  fprintf(fp_out, "			    specularColor	0.4 0.4 0.4\n");
  fprintf(fp_out, "			    transparency	0\n");
  fprintf(fp_out, "		  }\n");
  fprintf(fp_out, "	  }\n");
