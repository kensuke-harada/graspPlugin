...
namespace boost{
    namespace serialization{
        ...
        void save(Archive & ar,
                  ...
                  _MaxRows,_MaxCols> & m, const unsigned int version) {
        ...
        void load(Archive & ar,
                  ...
                  _MaxCols> & m, const unsigned int version) {
            int rows,cols;
            ar & rows;
            ar & cols;
            m.resize(rows,cols);
...
//        template <class Archive, typename _Scalar>
//        void serialize(Archive & ar, Eigen::Triplet<_Scalar> & m,
//                       const unsigned int version) {
//            split_free(ar,m,version);
//        }

//        template <class Archive, typename _Scalar, int _Options,typename _Index>
//        void save(Archive & ar, const Eigen::SparseMatrix<_Scalar,
//                  _Options,_Index> & m, const unsigned int version) {
//            int innerSize=m.innerSize();
//            int outerSize=m.outerSize();
//            typedef typename Eigen::Triplet<_Scalar> Triplet;
//            std::vector<Triplet> triplets;
//            for(int i=0; i < outerSize; ++i) {
//                for(typename Eigen::SparseMatrix<_Scalar,
//                    _Options,_Index>::InnerIterator it(m,i); it; ++it) {
...
//        template <class Archive, typename _Scalar, int _Options, typename _Index>
//        void serialize(Archive & ar, Eigen::SparseMatrix<_Scalar,_Options,
