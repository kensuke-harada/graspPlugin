...
#include <src/Collision/ColdetModelInternalModel.h>
#include <src/Collision/Opcode/Opcode.h>
#else
#include "../../../src/AISTCollisionDetector/ColdetModelInternalModel.h"
#include "../../../src/AISTCollisionDetector/Opcode/Opcode.h"
#endif
...
ExtCollisionPairInserter::ExtCollisionPairInserter()
{
...
void ExtCollisionPairInserter::copy_tri(col_tri* t1, tri* t2)
{
    t1->p1 = t2->p1;
    t1->p2 = t2->p2;
    t1->p3 = t2->p3;
...
void ExtCollisionPairInserter::copy_tri(col_tri* t1, col_tri* t2)
{
    t1->p1 = t2->p1;
    t1->p2 = t2->p2;
    t1->p3 = t2->p3;
...
void ExtCollisionPairInserter::calc_normal_vector(col_tri* t)
{
    if(t->status == 0){
...
int ExtCollisionPairInserter::is_convex_neighbor(col_tri* t1, col_tri* t2)
{
...
void ExtCollisionPairInserter::triangleIndexToPoint(ColdetModelInternalModel* model, int id, col_tri& tri){
...
void ExtCollisionPairInserter::get_triangles_in_convex_neighbor
...
int ExtCollisionPairInserter::get_triangles_in_convex_neighbor
...
void ExtCollisionPairInserter::examine_normal_vector(int id1, int id2, int ctype)
{
    check_separability(id1, id2, ctype);
}


void ExtCollisionPairInserter::check_separability(int id1, int id2, int ctype)
{
    ...
    case EE:
        cdContact[contactIndex].num_of_i_points = 2;
...
void ExtCollisionPairInserter::find_signed_distance(
...
int ExtCollisionPairInserter::new_point_test(int k)
{
...
// obsolute signatures
//
int ExtCollisionPairInserter::apply(
...
int ExtCollisionPairInserter::detectTriTriOverlap(
    const Vector3& P1,
    const Vector3& P2,
    const Vector3& P3,
    const Vector3& Q1,
    ...
    collision_data* col_p)
{
    return ext_tri_tri_overlap(P1, P2, P3, Q1, Q2, Q3, col_p, this);
}
