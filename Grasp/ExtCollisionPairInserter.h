...
#ifndef CNOID_COLLISION_EXT_COLLISION_PAIR_INSERTER_H_INCLUDED
#define CNOID_COLLISION_EXT_COLLISION_PAIR_INSERTER_H_INCLUDED


#if defined(CNOID_10_11_12_13) || defined(CNOID_14)
#include <src/Collision/CollisionPairInserter.h>
#else
#include "../../../src/AISTCollisionDetector/CollisionPairInserter.h"
#endif
...
namespace Opcode {
    ...
    class EXCADE_API ExtCollisionPairInserter : public CollisionPairInserter
    {
      public:
        ExtCollisionPairInserter();
        virtual ~ExtCollisionPairInserter();
